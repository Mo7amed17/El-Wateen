    ...
    return (
        ...
        {getPageItems(CurrentPage).map((Patient) => {
            ...
            <div className="PatientCard" key={Patient.id}>
                ...
                <div>
                    <h5 style={{ color:"rgb(156, 0, 0)"}}>العنوان</h5>
                    <h6 style={{ color:"rgb(156, 0, 0)"}}>{Patient?.location}</h6>
                </div>
                <div>
                    <h5 style={{ color:"rgb(156, 0, 0)"}}>رقم الهاتف</h5>
                    <h6 style={{ fontSize: "12px" ,color:"rgb(156, 0, 0)"}}>{Patient?.phone_number}</h6>
                </div>
                <div>
                    <h5 style={{ color:"rgb(156, 0, 0)"}}>عدد أكياس الدم</h5>
                    <h6 style={{ fontSize: "12px" ,color:"rgb(156, 0, 0)"}}>{Patient?.blood_number}</h6>
                </div>
                <div>
